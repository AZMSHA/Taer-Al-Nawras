...
export default function Section5() {
    const faqs = [
        ...
        [{title:"Intallation",description:"We offer comprehensive services for both completion and installation, ensuring a seamless process from design to the final placement of your signage.",},
